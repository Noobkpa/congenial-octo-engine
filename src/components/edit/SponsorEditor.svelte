...
function collectFromDOM() {
	...
	document.querySelectorAll(".sponsor-row").forEach((row) => {
		...
		const messageEl = row.querySelector(".sponsor-message");
...
function generateConfigTs(): string {
	...
	for (const s of state.sponsors.filter((s) => !s._deleted)) {
		...
		if (s.message) lines.push(`\t\t\tmessage: ${JSON.stringify(s.message)},`);
		lines.push("\t\t},");
	}
      ...
      <div class="sp-settings-grid">
        <div class="sp-form-group">
          ...
          <input
            ...
            class="sp-input"
            value={state.title}
            oninput={(e) => updateStateField("title", (e.target as HTMLInputElement).value)}
          />
        </div>
        <div class="sp-form-group">
          <label>页面描述</label>
          <input
            ...
            oninput={(e) => updateStateField("description", (e.target as HTMLInputElement).value)}
          />
        </div>
        <div class="sp-form-group sp-form-group-full">
          ...
          <input
            ...
            class="sp-input"
            value={state.usage}
            oninput={(e) => updateStateField("usage", (e.target as HTMLInputElement).value)}
            placeholder="说明赞助资金的用途，留空不显示"
          />
        </div>
      </div>
    </div>
                  ...
                  <div class="sp-form-row">
                    <div class="sp-form-group">
                      ...
                      <input
                        ...
                        class="sp-input"
                        value={m.name}
                        oninput={(e) => updateMethodField(i, "name", (e.target as HTMLInputElement).value)}
                        placeholder="如：微信支付"
                      />
                    </div>
                    <div class="sp-form-group">
                      ...
                      <input
                        ...
                        class="sp-input"
                        value={m.icon || ""}
                        oninput={(e) => updateMethodField(i, "icon", (e.target as HTMLInputElement).value)}
                        placeholder="如：fa7-brands:weixin"
                      />
                    </div>
                  </div>
                  <div class="sp-form-row">
                    <div class="sp-form-group">
                      ...
                      <input
                        ...
                        class="sp-input"
                        value={m.qrCode || ""}
                        oninput={(e) => updateMethodField(i, "qrCode", (e.target as HTMLInputElement).value)}
                        placeholder="如：/assets/images/wechat.png"
                      />
                    </div>
                    <div class="sp-form-group">
                      ...
                      <input
                        ...
                        class="sp-input"
                        value={m.link || ""}
                        oninput={(e) => updateMethodField(i, "link", (e.target as HTMLInputElement).value)}
                        placeholder="如：https://ifdian.net/a/xxx"
                      />
                    </div>
                  </div>
                  <div class="sp-form-group">
                    ...
                    <input
                      ...
                      class="sp-input"
                      value={m.description || ""}
                      oninput={(e) => updateMethodField(i, "description", (e.target as HTMLInputElement).value)}
                      placeholder="描述文本"
                    />
                  </div>
                  <div class="sp-form-group">
                    <label class="sp-checkbox-label">
                      <input
                        type="checkbox"
                        checked={m.enabled}
                        onchange={(e) => updateMethodField(i, "enabled", (e.target as HTMLInputElement).checked)}
                      />
                      启用该支付方式
                    </label>
                  </div>
                ...
                <div class="sp-card-edit">
                  ...
                  <div class="sp-form-row">
                    <div class="sp-form-group">
                      ...
                      <input
                        ...
                        class="sp-input"
                        value={s.name}
                        oninput={(e) => updateSponsorField(i, "name", (e.target as HTMLInputElement).value)}
                        placeholder="赞助者名称"
                      />
                    </div>
                    <div class="sp-form-group">
                      ...
                      <input
                        ...
                        class="sp-input"
                        value={s.amount || ""}
                        oninput={(e) => updateSponsorField(i, "amount", (e.target as HTMLInputElement).value)}
                        placeholder="如：¥50"
                      />
                    </div>
                  </div>
                  <div class="sp-form-row">
                    <div class="sp-form-group">
                      ...
                      <input
                        ...
                        class="sp-input"
                        value={s.date || ""}
                        oninput={(e) => updateSponsorField(i, "date", (e.target as HTMLInputElement).value)}
                      />
                    </div>
                    <div class="sp-form-group">
                      <label>头像 URL</label>
                      <input
                        ...
                        class="sp-input"
                        value={s.avatar || ""}
                        oninput={(e) => updateSponsorField(i, "avatar", (e.target as HTMLInputElement).value)}
                        placeholder="头像图片链接"
                      />
                    </div>
                  </div>
                  <div class="sp-form-group">
                    ...
                    <input
                      ...
                      class="sp-input"
                      value={s.message || ""}
                      oninput={(e) => updateSponsorField(i, "message", (e.target as HTMLInputElement).value)}
                      placeholder="赞助者留言"
                    />
                  </div>
                  <div class="sp-form-actions">
...
<style>
  ...
  :global(.dark) .sp-btn-cancel:hover {
    background: #3d3d55;
  }
  .sp-btn-save {
    background: hsl(var(--theme-hue, 165), 70%, 50%);
